...
@else
	@section('title','Add Physiotherapist  ')
@endif
	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				<a href="{{route('physiotherapist.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Physiotherapist </a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-info">
					...
					<div class="panel-wrapper collapse in" aria-expanded="true">
						<div class="panel-body">
								@if(isset($editModeData))
									{{ Form::model($editModeData, array('route' => array('physiotherapist.update', $editModeData->user_id), 'method' => 'PUT','files' => 'true','class' => 'form-horizontal')) }}
								@else
									{{ Form::open(array('route' => 'physiotherapist.store','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
								@endif
								<div class="form-body">
									<div class="row">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::textarea('profile',Input::old('profile'), $attributes = array('class'=>'form-control profile','rows'=>'4','id'=>'profile','placeholder'=>'Physiotherapist profile..')) !!}
												</div>
											</div>
										</div>
									</div>
    ...
    $(document).ready(function(){
		...
		@php
			...
			if(isset($editModeData->avatar_file) && $editModeData->avatar_file !=''){
				 $profilePic ="uploads/physiotherapist_profile/".$editModeData->avatar_file;
			}
		@endphp
